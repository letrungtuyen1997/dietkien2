...
public class Bee extends Insect {
  public Bee(TextureAtlas atlas, GLayerGroup insectsGroup, PoolInsects pool){
    info = "Bee";
    this.atlas = atlas;
  ...
  private void initAni(){
    ani = new animation(group.getWidth()/2,group.getHeight()/2,"animationOng",1,4,0.1f,false,true);
    group.addActor(ani);
  }

  private void initCorpses(){
    corpses = GUI.createImage(atlas, "OngDie");
  ...
  private void addClick(){
    group.addListener(new ClickListener(){
      ...
      click(-1);
      pool.checkOverlapInsect(new Vector2(group.getX(), group.getY()), Bee.this);

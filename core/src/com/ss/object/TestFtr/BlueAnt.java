...
public class BlueAnt extends Insect {


  public BlueAnt(TextureAtlas atlas, GLayerGroup insectsGroup, PoolInsects pool){
    info = "Blue Ant";
    this.atlas = atlas;
  ...
  private void initAni(){
    ani = new animation(group.getWidth()/2,group.getHeight()/2,"animationKien2",1,4,0.1f,false,true);
    group.addActor(ani);
  }

  private void initCorpses(){
    corpses = GUI.createImage(atlas, "KienDie02");
  ...
  private void addClick(){
    group.addListener(new ClickListener(){
      ...
      click(-1);
      pool.checkOverlapInsect(new Vector2(group.getX(), group.getY()), BlueAnt.this);
...
//    }
//    else {
//      int indexTemp = pool.getIndexWok(id, BlueAnt.this);
//      pool.removeInsWok(id, indexTemp);
//    }

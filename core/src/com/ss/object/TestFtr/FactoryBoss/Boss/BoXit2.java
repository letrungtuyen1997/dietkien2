...
public class BoXit2 extends Boss {
  public BoXit2(TextureAtlas atlas, GLayerGroup insectsGroup, PoolInsects pool){
    info = "BoXit2";
    this.id = pool.ID_B_BOXIT2;
    this.atlas = atlas;
  ...
  private void initAni(){
    ani = new animation(group.getWidth()/2,group.getHeight()/2,"animationBoxit2",1,4,0.1f,false,true);
    group.addActor(ani);
  }

  private void initCorpses(){
    corpses = GUI.createImage(atlas, "BoXitDie2");

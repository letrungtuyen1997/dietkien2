...
public class CoconutWeevil extends Boss {
  public CoconutWeevil(TextureAtlas atlas, GLayerGroup insectsGroup, PoolInsects pool){
    info = "CoconutWeevil";
    this.id = pool.ID_B_COCONUTWEEVIL;
    this.atlas = atlas;
  ...
  private void initAni(){
    ani = new animation(group.getWidth()/2,group.getHeight()/2,"animationDuo",1,4,0.1f,false,true);
    group.addActor(ani);
  }

  private void initCorpses(){
    corpses = GUI.createImage(atlas, "DuongDie");

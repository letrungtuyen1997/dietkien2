...
public class HornedBeetle1 extends Boss {
  public HornedBeetle1(TextureAtlas atlas, GLayerGroup insectsGroup, PoolInsects pool){
    info = "HornedBeetle1";
    this.id = pool.ID_B_HORNEDBEETLE1;
    this.atlas = atlas;
  ...
  private void initAni(){
    ani = new animation(group.getWidth()/2,group.getHeight()/2,"animationSug1",1,4,0.1f,false,true);
    group.addActor(ani);
  }

  private void initCorpses(){
    corpses = GUI.createImage(atlas, "SungDie1");

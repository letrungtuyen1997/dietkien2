...
public class HornedBeetle2 extends Boss {
  public HornedBeetle2(TextureAtlas atlas, GLayerGroup insectsGroup, PoolInsects pool){
    info = "HornedBeetle2";
    this.id = pool.ID_B_HORNEDBEETLE2;
    this.atlas = atlas;
  ...
  private void initAni(){
    ani = new animation(group.getWidth()/2,group.getHeight()/2,"animationSug2",1,4,0.1f,false,true);
    group.addActor(ani);
  }

  private void initCorpses(){
    corpses = GUI.createImage(atlas, "SungDie2");
